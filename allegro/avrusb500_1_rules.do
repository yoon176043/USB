...
# REGION DEFINITIONS                                                           #
################################################################################
define (region FT232_1_0 (polygon TOP 0 63.5000 33.0200 68.5800 33.0200 68.5800 30.4800 63.5000 30.4800 63.5000 33.0200 ))
...
################################################################################
rule PCB (width 0.2530)
rule PCB (clearance 0.1270 (type buried_via_gap))
rule PCB (clearance 0.2530 (type wire_wire))
rule PCB (clearance 0.1270 (type wire_smd))
rule PCB (clearance 0.2530 (type wire_pin))
rule PCB (clearance 0.2530 (type wire_via))
...
################################################################################
# rule assignments for region clearances                                       #
################################################################################
...
################################################################################
# rule assignments for region wiring                                           #
################################################################################
################################################################################
# VIA_AT_SMD RULES                                                            #
################################################################################
